...
public class workout_6 extends Fragment implements View.OnClickListener {
    ...
    private WTable_6_Dao wTable6Dao;
    private WorkoutTable_6 WRow1, WRow2, WRow3, WRow4, WRow5, WRow6, WRow7, WRow8, WRow9, WRow10;
    ...
    {
        finishBtn = view.findViewById(R.id.finishBtn6);
    ...
    public void initMoveWeightRep(View view) {
        ...
        inWeight1 = view.findViewById(R.id.inWeight6_1);
        inWeight2 = view.findViewById(R.id.inWeight6_2);
        inWeight3 = view.findViewById(R.id.inWeight6_3);
        inWeight4 = view.findViewById(R.id.inWeight6_4);
        inWeight5 = view.findViewById(R.id.inWeight6_5);
        inWeight6 = view.findViewById(R.id.inWeight6_6);
        inWeight7 = view.findViewById(R.id.inWeight6_7);
        inWeight8 = view.findViewById(R.id.inWeight6_8);
        inWeight9 = view.findViewById(R.id.inWeight6_9);
        inWeight10 = view.findViewById(R.id.inWeight6_10);

        inReps1 = view.findViewById(R.id.inReps6_1);
        inReps2 = view.findViewById(R.id.inReps6_2);
        inReps3 = view.findViewById(R.id.inReps6_3);
        inReps4 = view.findViewById(R.id.inReps6_4);
        inReps5 = view.findViewById(R.id.inReps6_5);
        inReps6 = view.findViewById(R.id.inReps6_6);
        inReps7 = view.findViewById(R.id.inReps6_7);
        inReps8 = view.findViewById(R.id.inReps6_8);
        inReps9 = view.findViewById(R.id.inReps6_9);
        inReps10 = view.findViewById(R.id.inReps6_10);

        inSpinner1 = view.findViewById(R.id.workoutSpinner6_1);
        inSpinner2 = view.findViewById(R.id.workoutSpinner6_2);
        inSpinner3 = view.findViewById(R.id.workoutSpinner6_3);
        inSpinner4 = view.findViewById(R.id.workoutSpinner6_4);
        inSpinner5 = view.findViewById(R.id.workoutSpinner6_5);
        inSpinner6 = view.findViewById(R.id.workoutSpinner6_6);
        inSpinner7 = view.findViewById(R.id.workoutSpinner6_7);
        inSpinner8 = view.findViewById(R.id.workoutSpinner6_8);
        inSpinner9 = view.findViewById(R.id.workoutSpinner6_9);
        inSpinner10 = view.findViewById(R.id.workoutSpinner6_10);
    ...
    public void insertIntoDB() {
        ...
        if (pairIsValid(inWeight1, inReps1)) {
            WRow1 = new WorkoutTable_6(0, inSpinner1.getSelectedItem().toString(), 1, getInt(inWeight1), getInt(inReps1));
            wTable6Dao.addWork(WRow1);
            inWeight1.setHint(null);
            inReps1.setHint(null);
        }
        if (pairIsValid(inWeight2, inReps2)) {
            WRow2 = new WorkoutTable_6(0, inSpinner2.getSelectedItem().toString(), 2, getInt(inWeight2), getInt(inReps2));
            wTable6Dao.addWork(WRow2);
            inWeight2.setHint(null);
            inReps2.setHint(null);
        }
        if (pairIsValid(inWeight3, inReps3)) {
            WRow3 = new WorkoutTable_6(0, inSpinner3.getSelectedItem().toString(), 3, getInt(inWeight3), getInt(inReps3));
            wTable6Dao.addWork(WRow3);
            inWeight3.setHint(null);
            inReps3.setHint(null);
        }
        if (pairIsValid(inWeight4, inReps4)) {
            WRow4 = new WorkoutTable_6(0, inSpinner4.getSelectedItem().toString(), 4, getInt(inWeight4), getInt(inReps4));
            wTable6Dao.addWork(WRow4);
            inWeight4.setHint(null);
            inReps4.setHint(null);
        }
        if (pairIsValid(inWeight5, inReps5)) {
            WRow5 = new WorkoutTable_6(0, inSpinner5.getSelectedItem().toString(),5, getInt(inWeight5), getInt(inReps5));
            wTable6Dao.addWork(WRow5);
            inWeight5.setHint(null);
            inReps5.setHint(null);
        }
        if (pairIsValid(inWeight6, inReps6)) {
            WRow6 = new WorkoutTable_6(0, inSpinner6.getSelectedItem().toString(),6, getInt(inWeight6), getInt(inReps6));
            wTable6Dao.addWork(WRow6);
            inWeight6.setHint(null);
            inReps6.setHint(null);
        }
        if (pairIsValid(inWeight7, inReps7)) {
            WRow7 = new WorkoutTable_6(0, inSpinner7.getSelectedItem().toString(),7, getInt(inWeight7), getInt(inReps7));
            wTable6Dao.addWork(WRow7);
            inWeight7.setHint(null);
            inReps7.setHint(null);
        }
        if (pairIsValid(inWeight8, inReps8)) {
            WRow8 = new WorkoutTable_6(0, inSpinner8.getSelectedItem().toString(),8, getInt(inWeight8), getInt(inReps8));
            wTable6Dao.addWork(WRow8);
            inWeight8.setHint(null);
            inReps8.setHint(null);
        }
        if (pairIsValid(inWeight9, inReps9)) {
            WRow9 = new WorkoutTable_6(0, inSpinner9.getSelectedItem().toString(), 9, getInt(inWeight9), getInt(inReps9));
            wTable6Dao.addWork(WRow9);
            inWeight9.setHint(null);
            inReps9.setHint(null);
        }
        if (pairIsValid(inWeight10, inReps10)) {
            WRow10 = new WorkoutTable_6(0, inSpinner10.getSelectedItem().toString(),10, getInt(inWeight10), getInt(inReps10));
            wTable6Dao.addWork(WRow10);
