...
public class MapActivity extends AppCompatActivity {
    ...
    {
        mapSwitch = findViewById(R.id.Map_toMap);
        ...
        workoutSwitch = findViewById(R.id.Map_toWorkout);
        ...
        mainSwitch = findViewById(R.id.Map_toMain);
