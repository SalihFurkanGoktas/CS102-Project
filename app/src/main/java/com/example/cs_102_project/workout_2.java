...
public class workout_2 extends Fragment implements View.OnClickListener {
    ...
    private WTable_2_Dao wTable2Dao;
    private WorkoutTable_2 WRow1, WRow2, WRow3, WRow4, WRow5, WRow6, WRow7, WRow8, WRow9, WRow10;
    ...
    public void insertIntoDB() {
        ...
        if (pairIsValid(inWeight1, inReps1)) {
            WRow1 = new WorkoutTable_2(0, inSpinner1.getSelectedItem().toString(), 1, getInt(inWeight1), getInt(inReps1));
            wTable2Dao.addWork(WRow1);
            inWeight1.setHint(null);
            inReps1.setHint(null);
        }
        if (pairIsValid(inWeight2, inReps2)) {
            WRow2 = new WorkoutTable_2(0, inSpinner2.getSelectedItem().toString(), 2, getInt(inWeight2), getInt(inReps2));
            wTable2Dao.addWork(WRow2);
            inWeight2.setHint(null);
            inReps2.setHint(null);
        }
        if (pairIsValid(inWeight3, inReps3)) {
            WRow3 = new WorkoutTable_2(0, inSpinner3.getSelectedItem().toString(), 3, getInt(inWeight3), getInt(inReps3));
            wTable2Dao.addWork(WRow3);
            inWeight3.setHint(null);
            inReps3.setHint(null);
        }
        if (pairIsValid(inWeight4, inReps4)) {
            WRow4 = new WorkoutTable_2(0, inSpinner4.getSelectedItem().toString(), 4, getInt(inWeight4), getInt(inReps4));
            wTable2Dao.addWork(WRow4);
            inWeight4.setHint(null);
            inReps4.setHint(null);
        }
        if (pairIsValid(inWeight5, inReps5)) {
            WRow5 = new WorkoutTable_2(0, inSpinner5.getSelectedItem().toString(),5, getInt(inWeight5), getInt(inReps5));
            wTable2Dao.addWork(WRow5);
            inWeight5.setHint(null);
            inReps5.setHint(null);
        }
        if (pairIsValid(inWeight6, inReps6)) {
            WRow6 = new WorkoutTable_2(0, inSpinner6.getSelectedItem().toString(),6, getInt(inWeight6), getInt(inReps6));
            wTable2Dao.addWork(WRow6);
            inWeight6.setHint(null);
            inReps6.setHint(null);
        }
        if (pairIsValid(inWeight7, inReps7)) {
            WRow7 = new WorkoutTable_2(0, inSpinner7.getSelectedItem().toString(),7, getInt(inWeight7), getInt(inReps7));
            wTable2Dao.addWork(WRow7);
            inWeight7.setHint(null);
            inReps7.setHint(null);
        }
        if (pairIsValid(inWeight8, inReps8)) {
            WRow8 = new WorkoutTable_2(0, inSpinner8.getSelectedItem().toString(),8, getInt(inWeight8), getInt(inReps8));
            wTable2Dao.addWork(WRow8);
            inWeight8.setHint(null);
            inReps8.setHint(null);
        }
        if (pairIsValid(inWeight9, inReps9)) {
            WRow9 = new WorkoutTable_2(0, inSpinner9.getSelectedItem().toString(), 9, getInt(inWeight9), getInt(inReps9));
            wTable2Dao.addWork(WRow9);
            inWeight9.setHint(null);
            inReps9.setHint(null);
        }
        if (pairIsValid(inWeight10, inReps10)) {
            WRow10 = new WorkoutTable_2(0, inSpinner10.getSelectedItem().toString(),10, getInt(inWeight10), getInt(inReps10));
            wTable2Dao.addWork(WRow10);
